...
trainLoaders, testLoaders, heldLoader = getLoader(C.DATASET)
...
def KTtrain():
    ...
    for epoch in range(C.EPOCH):
        ...
        model, optimizer = eval.train_epoch(model, trainLoaders, optimizer, scheduler, loss_func)
...
def KTtest():
    ...
    model.load_state_dict(torch.load('../model/save2017modelS_weights.pth')) # replace to your model path
